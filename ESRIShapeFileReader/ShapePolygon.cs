...
namespace ESRIShapeFileReader
{
    ...
    public class ShapePolygon : Shape
    {
        ...
        protected internal ShapePolygon(int recordNumber, StringDictionary metadata, Reader reader, byte[] shapeData)
            : base(ShapeType.Polygon, recordNumber, metadata, reader)
        {
