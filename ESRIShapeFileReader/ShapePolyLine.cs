...
namespace ESRIShapeFileReader
{
    ...
    public class ShapePolyLine : Shape
    {
        ...
        protected internal ShapePolyLine(int recordNumber, StringDictionary metadata, Reader reader)
            : base(ShapeType.PolyLine, recordNumber, metadata, reader) {}
        ...
        protected internal ShapePolyLine(int recordNumber, StringDictionary metadata, Reader reader, byte[] shapeData)
            : base(ShapeType.PolyLine, recordNumber, metadata, reader)
        {
