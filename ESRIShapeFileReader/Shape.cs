...
namespace ESRIShapeFileReader
{
    ...
    public class Shape
    {
        ...
        /// <param name="reader">Reader associated with the shape</param>
        protected internal Shape(ShapeType shapeType, int recordNumber, StringDictionary metadata, Reader reader)
        {
            _type = shapeType;
            _metadata = metadata;
        ...
        /// <summary>
        /// Returns the Reader associated with the shape metadata
        /// </summary>
